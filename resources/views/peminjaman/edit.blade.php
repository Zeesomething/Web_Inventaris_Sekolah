        ...
        <div class="card-body">
            ...
            <form action="{{ route('peminjaman.update', $pinjam->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <select name="id_barang" class="form-control" id="" value="{{ $pinjam->pusat->nama }}" style="color: #ffffff;">
                ...
                <div class="form-group">
                    ...
                    <select name="id_barang" class="form-control" id="" value="{{ $pinjam->pusat->merek }}" style="color: #ffffff;">
                        @foreach ($pusat as $data)
                            <option value="{{ $data->id }}" {{ $data->id == $pinjam->pusat->id ? 'selected' : '' }}>
                                {{ $data->merek }}
                            </option>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleInputEmail3" placeholder="Merek" name="jumlah"
                        value="{{ $pinjam->jumlah }}" style="color: #ffffff;">
                </div>
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="exampleInputPassword4" placeholder="Stok"
                        name="tgl_pinjam" value="{{ $pinjam->tgl_pinjam }}" style="color: #ffffff;">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword4">Tanggal Kembali</label>
                    <input type="date" class="form-control" id="exampleInputPassword4" placeholder="Stok"
                        name="tgl_kembali" value="{{ $pinjam->tgl_kembali }}" style="color: #ffffff;">
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Stok"
                        name="nama_peminjam" value="{{ $pinjam->nama_peminjam }}" style="color: #ffffff;">
                </div>
                <div class="form-group">
